            ...
            <Container >
                ...
                <Row className="border-top py-4">
                    ...
                    <div className="m-2 d-flex justify-content-end">
                        ...
                        <a style={{ color: "#FFFFFF", marginLeft: "32px" }} href="#terms">Terms</a>
                        <a style={{ color: "#FFFFFF", marginLeft: "32px" }} href="#pricing">Pricing</a>
                        <span style={{ marginLeft: "32px" }}>&#169; 2020 Uber Technologies Inc.</span>
                    </div>
                </Row>
            </Container>
        </div>
